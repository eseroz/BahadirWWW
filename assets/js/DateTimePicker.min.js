(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        titleContentDate: "Tarih Seç",
        titleContentTime: "Saat Seç",
        titleContentDateTime: "Tarih & Saat",
        setButtonContent: "Seç",
        ...
        setOutput: function () {
            ...
            if (dtPickerObj.settings.mode == "date") {
                if (dtPickerObj.settings.dateFormat == dtPickerObj.dataObject.sArrInputDateFormats[0]) {
                    ...
                    if (dtPickerObj.settings.dateFormat == dtPickerObj.dataObject.sArrInputDateFormats[1]) {
                        iMonth++;
                        var sDate = (iDate < 10) ? ("0" + iDate) : iDate;
                        var sMonth = (iMonth < 10) ? ("0" + iMonth) : iMonth;
                        sOutput = sMonth + dtPickerObj.settings.dateSeparator + sDate + dtPickerObj.settings.dateSeparator + iYear
                    } else {
                        if (dtPickerObj.settings.dateFormat == dtPickerObj.dataObject.sArrInputDateFormats[2]) {
                            iMonth++;
                            var sDate = (iDate < 10) ? ("0" + iDate) : iDate;
                            var sMonth = (iMonth < 10) ? ("0" + iMonth) : iMonth;
                ...
                if (dtPickerObj.settings.mode == "time") {
                    if (dtPickerObj.settings.timeFormat == dtPickerObj.dataObject.sArrInputTimeFormats[0]) {
                        ...
                        if (dtPickerObj.settings.timeFormat == dtPickerObj.dataObject.sArrInputTimeFormats[1]) {
                            var sHour = (iHour < 10) ? ("0" + iHour) : iHour;
                            var sMinutes = (iMinutes < 10) ? ("0" + iMinutes) : iMinutes;
                    ...
                    if (dtPickerObj.settings.mode == "datetime") {
                        var sDateStr = "";
                        var sTimeStr = "";
                        if ((dtPickerObj.settings.dateTimeFormat == dtPickerObj.dataObject.sArrInputDateTimeFormats[0]) || (dtPickerObj.settings.dateTimeFormat == dtPickerObj.dataObject.sArrInputDateTimeFormats[1])) {
                            ...
                            if ((dtPickerObj.settings.dateTimeFormat == dtPickerObj.dataObject.sArrInputDateTimeFormats[2]) || (dtPickerObj.settings.dateTimeFormat == dtPickerObj.dataObject.sArrInputDateTimeFormats[3])) {
                                iMonth++;
                                var sDate = (iDate < 10) ? ("0" + iDate) : iDate;
                                var sMonth = (iMonth < 10) ? ("0" + iMonth) : iMonth;
                                sDateStr = sMonth + dtPickerObj.settings.dateSeparator + sDate + dtPickerObj.settings.dateSeparator + iYear
                            } else {
                                if ((dtPickerObj.settings.dateTimeFormat == dtPickerObj.dataObject.sArrInputDateTimeFormats[4]) || (dtPickerObj.settings.dateTimeFormat == dtPickerObj.dataObject.sArrInputDateTimeFormats[5])) {
                                    iMonth++;
                                    var sDate = (iDate < 10) ? ("0" + iDate) : iDate;
                                    var sMonth = (iMonth < 10) ? ("0" + iMonth) : iMonth;
                                    sOutput = iYear + dtPickerObj.settings.dateSeparator + sMonth + dtPickerObj.settings.dateSeparator + sDate
            ...
            if (dtPickerObj.settings.mode == "date") {
                ...
                if (dtPickerObj.settings.mode == "time") {
                    ...
                    if (dtPickerObj.settings.mode == "datetime") {
                        ...
                        dtPickerObj.dataObject.bIs12Hour = (dtPickerObj.settings.dateTimeFormat == dtPickerObj.dataObject.sArrInputDateTimeFormats[1] || dtPickerObj.settings.dateTimeFormat == dtPickerObj.dataObject.sArrInputDateTimeFormats[3] || dtPickerObj.settings.dateTimeFormat == dtPickerObj.dataObject.sArrInputDateTimeFormats[5])
                    }
                }
            }
        ...
        addEventHandlersForPicker: function () {
            ...
            $(dtPickerObj.element).find(".meridiem .dtpicker-compButton").click(function () {
                if (dtPickerObj.dataObject.sCurrentMeridiem == "AM") {
                    ...
                    if (dtPickerObj.dataObject.sCurrentMeridiem == "PM") {
            ...
            if (dtPickerObj.settings.mode == "time") {
                ...
                if (dtPickerObj.settings.timeFormat == dtPickerObj.dataObject.sArrInputTimeFormats[0]) {
                    if (dtPickerObj.dataObject.iCurrentHour > 12) {
                        ...
                        if (dtPickerObj.dataObject.iCurrentHour == 12 && dtPickerObj.dataObject.iCurrentMinutes > 0) {
                            dtPickerObj.dataObject.sCurrentMeridiem = "PM"
                        } else {
                            dtPickerObj.dataObject.sCurrentMeridiem = "AM"
                        }
