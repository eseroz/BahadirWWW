<aside id="slide-out" class="side-nav white fixed">
    <div class="side-nav-wrapper">
        <div class="sidebar-profile">
            ...
            <div class="sidebar-profile-info">
                <a href="javascript:void(0);" class="account-settings-link">
                    <p>Eser</p>
                    <span>eser@bahadir.com<i class="material-icons right">arrow_drop_down</i></span>
                </a>
            </div>
        </div>
        ...
        <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
            ...
            <li class="no-padding">
                <a class="waves-effect waves-grey active" href="?view=dashboard">
                    <i class="material-icons">settings_input_svideo</i>Gösterge Paneli
                </a>
            </li>
                               
            <li class="no-padding">
                <a class="waves-effect waves-grey active" href="?view=home">
                    <i class="material-icons">done_all</i>Anasayfa
                </a>
            </li>
            
            <li class="no-padding">
                <a class="waves-effect waves-grey active" href="?view=corprate">
                    <i class="material-icons">done_all</i>Kurumsal
                </a>
            </li>  
            
            
            <li class="no-padding">
                <a class="waves-effect waves-grey active" href="?view=career">
                    <i class="material-icons">done_all</i>Kariyer
                </a>
            </li>  
            ...
            <li class="no-padding">
                <a class="waves-effect waves-grey active" href="?view=products">
                    <i class="material-icons">done_all</i>Ürünler
                </a>
            </li>

            
            <li class="no-padding">
                <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">done_all</i>Destek<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                <div class="collapsible-body">
                    <ul>
                        <li><a href="?view=sayfalar">Servis</a></li>
                        <li><a href="?view=sayfalar">İndirme</a></li>
                        <li><a href="?view=sayfalar">Çevrimiçi Katalog</a></li>
                    </ul>
                </div>
            </li>
            
            <li class="no-padding">
                <a class="waves-effect waves-grey" href="?view=contact">
                    <i class="material-icons">view_carousel</i>İletişim
                </a>
            </li>

            <li class="no-padding">
                <a class="waves-effect waves-grey" href="?view=news">
                    <i class="material-icons">view_carousel</i>Haberler
                </a>
            </li>

            <li class="no-padding">
                <a class="waves-effect waves-grey" href="?view=translate">
                    <i class="material-icons">view_carousel</i>Dil ve Çeviri
                </a>
            </li>

            <li class="no-padding">
                <a class="waves-effect waves-grey" href="?view=settings">
                    <i class="material-icons">view_carousel</i>Site Ayarları
                </a>
            </li>
            ...
            <li class="no-padding">
                <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">done_all</i>Layouts<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                <div class="collapsible-body">
                    <ul>
        ...
        <div class="footer">
            <p class="copyright">© 2017 Bahadır IT </p>
        </div>
    </div>
</aside>