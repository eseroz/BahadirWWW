...
$IK_YONETIMI = $bahadir->mssqlDb->Select("SELECT *FROM site.PAGES WHERE ID = 5")[0];
...
<div class="row">
    ...
    <div class="col s12">
        <ul class="tabs tab-demo z-depth-1" style="width: 100%;">
            <li class="tab col s3">
                <a href="#ik-yonetimi" class="active">
                    <?php echo $bahadir->TRANSLATE_WORD("insan kaynakları yönetimi", 1); ?>
                </a>
            </li>
            <li class="tab col s3">
                <a class="" href="#ozgecmis-formu">
                    <?php echo $bahadir->TRANSLATE_WORD("özgeçmiş formu", 1); ?>
                </a>
            </li>
            <li class="tab col s3">
                <a class="" href="#acik-pozisyonlar">
                    <?php echo $bahadir->TRANSLATE_WORD("açık pozisyonlar", 1); ?>
                </a>
            </li>
    ...
    <div id="ik-yonetimi" class="col s12 x-content" style="display: block;margin-top:20px;">
         <form method="post" enctype="multipart/form-data">
            ...
            <div class="card-content">
                ...
                <div class="input-field col s12">
                    <input type="text" name="title1" value="<?php echo $IK_YONETIMI["TITLE1"]; ?>" placeholder="<?php echo $bahadir->TRANSLATE_WORD("üst başlık", 1); ?>" />
                    <label>Üst Başlık</label>
                </div>

                <div class="input-field col s12">
                    <input type="text" name="title2" value="<?php echo $IK_YONETIMI["TITLE2"]; ?>" placeholder="<?php echo $bahadir->TRANSLATE_WORD("alt başlık", 1); ?>" />
                    <label>Alt Başlık</label>
                </div>

                <div class="input-field col s12">
                    <textarea name="description" class="materialize-textarea" placeholder="<?php echo $bahadir->TRANSLATE_WORD("açıklama", 1); ?>"><?php echo $IK_YONETIMI["DESCRIPTION"]; ?></textarea>
                ...
                <div class="col s12 m12 l12">
                    ...
                    <div class="card">
                        <div class="card-content" style="height:auto;overflow:hidden;min-height:200px;">
                            <?php
                            $HEADER_IMAGE_EXIST = $IK_YONETIMI["HEADER_IMAGE"] == null?0:1;
                            if($HEADER_IMAGE_EXIST == 1){
                            ?>
                            <img name='img_page_header' src="/panel/system/ViewBinaryImage.php?OPTION=PAGE_HEADER&ID=<?php echo $IK_YONETIMI["ID"]; ?>" style="" width="100%" />
                            <?php
                            }
                            ?>
                ...
                <div class="col s12">
                    ...
                    <textarea x-type="content" name="left_content">
                        <?php echo $IK_YONETIMI["CONTENT_LEFT"]; ?>
                    </textarea>
                </div>
            </div>
    ...
    <div id="ozgecmis-formu" class="col s12 x-content" style="display: block;margin-top:20px;">
        <form method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="2" />
            <input type="hidden" name="selected_page" />
            <div class="card-content">
    ...
    <div id="acik-pozisyonlar" class="col s12 x-content" style="display: block;margin-top:20px;">
        <form method="post" enctype="multipart/form-data">
